...
229 different types of bird were only ever sighted on their own. <br/>
...
The different types of penguin were identified by looking for the word 'penguin' anywhere in the birds common name. <br/>

There were 154 sightings of penguin. <br/>
```{r}
pattern <- "penguin"
